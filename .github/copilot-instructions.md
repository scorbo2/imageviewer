...
4. **Build the complete package** (includes compile, test, jar, javadoc, and sources):
   ...
   - Produces:
     - `target/imageviewer-2.3.jar` (~308KB) - Main application JAR
     - `target/imageviewer-2.3-sources.jar` (~205KB) - Source JAR
     - `target/imageviewer-2.3-javadoc.jar` (~617KB) - Javadoc JAR
...
- **swing-extras 2.5.0**: Custom Swing components (ca.corbett)
